...
cat Recon/$1/$1-allDomain.txt | httprobe -c 300 > Recon/$1/$1-httprobe.txt
...
python3 ~/tools/subdover/subdover.py -t 300 -l Recon/$1/$1-httprobe.txt -o Recon/$1/$1-subdomain-takeover.txt
